...
admin.get('/index',validation.isLogin,adminCrtl.index)
...
admin.post('/returnapprove',adminCrtl.return_apporved)
// CHART
...
// OFFER
admin.get('/addofferproduct',adminCrtl.addoffer_page)
admin.post('/addofferproduct',upload.array('image'),adminCrtl.post_addoffer)
// OFFER- ROUTER
admin.get('/offerproducts',adminCrtl.page_offer)
// admin_logout
